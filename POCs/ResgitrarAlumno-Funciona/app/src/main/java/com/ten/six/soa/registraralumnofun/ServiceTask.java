...
public class ServiceTask extends AsyncTask<Void,Void,String> {
    ...
    protected String doInBackground(Void... params) {
        ...
        URL url = null;
        RegistroLoginDTO responseBody;
        //AlumnoDTO alu;
        //RegistrarEventDTO even;
        IRequest req;
        ...
        try{
           ...
           if(HttpURLConnection.HTTP_CREATED == responseCode || HttpURLConnection.HTTP_OK == responseCode){
                ...
                responseBody = RegistroLoginDTO.toObjeto(result);
                //Log.e("MARIAN"," Response: " + responseBody.toJson());
           }
           else{

               //Log.e("MARIAN"," error: "+ msj );
